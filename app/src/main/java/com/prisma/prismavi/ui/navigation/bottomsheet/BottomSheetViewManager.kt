...
class BottomSheetViewManager(private val viewModelManager: ViewModelManager) {
    ...
    fun RenderContent() {
        when (currentContent) {
            is BottomSheetScreen.ColorDetails -> ColorDetails(viewModelManager.colorViewModel)
